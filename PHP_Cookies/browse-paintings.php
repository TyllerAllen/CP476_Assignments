...
<html lang="en">
    ...
    <body>
        <a href="https://hopper.wlu.ca/~alle5940/CP476A5/browse-paintings.php"></a>
                    ...
                    <li class="item">
                        ...
                        <div class="itemright">
                            ...
                            <div class="extra" >
                                ...
                                <span> &nbsp; &nbsp; &nbsp;    </span>
                                <a  class="favorites"   href="addToWishList.php?PaintingID=<?php echo utf8_encode($row['PaintingID']) . '&ImageFileName=' . utf8_encode($row['ImageFileName']) . '&Title=' . urldecode($row['Title']);/* PaintingID  */ ?>">	Add to Wish List</i>
                                </a>         
                                <p>&nbsp;</p>
                            </div>       
